...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setAdapter(new PizzaAdapter(fs.findAll(), HomeActivity.this ));
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               // TextView nbringredientss = view.findViewById(R.id.nbrIngredients);

               // TextView dureee = view.findViewById(R.id.duree);


                 //nomm = view.findViewById(R.id.nom);


                // detaisingredd = view.findViewById(R.id.detaisingredients);
                // descriptionn = view.findViewById(R.id.description);
                // preparationn = view.findViewById(R.id.preparation);


               // String iditem = idd.getText().toString();

                // nomitem = nomm.getText().toString();
                // detaisingreditem = detaisingredd.getText().toString();
              //   descriptionitem = descriptionn.getText().toString();
               //  preparationitem = preparationn.getText().toString();


                 TextView idd = view.findViewById(R.id.id);
                 String iditem = idd.getText().toString();
                 int iddabab = Integer.parseInt(iditem);

                 String nomitem = fs.findById(iddabab).getNom();
                 String detaisingreditem = fs.findById(iddabab).getDetaisIngred();
                 String descriptionitem = fs.findById(iddabab).getDescription();
                 String preparationitem = fs.findById(iddabab).getPreparation();



                 int imageitem = fs.findById(iddabab).getPhoto();



                //String rakine = Integer.toString(imageitem);


                 //Toast.makeText(getApplicationContext(),imageitem+"",Toast.LENGTH_LONG).show();

                Intent intent = new Intent(HomeActivity.this, DetailsActivity.class);

                intent.putExtra(DetailsActivity.NOM,nomitem);
                intent.putExtra(DetailsActivity.DETAISINGRED,detaisingreditem);
                intent.putExtra(DetailsActivity.DESCRIPTION,descriptionitem);
                intent.putExtra(DetailsActivity.PREPARATION,preparationitem);

                intent.putExtra(DetailsActivity.IMAGE, imageitem);



                // intent.putExtra(DetailsActivity.,nomitem);
